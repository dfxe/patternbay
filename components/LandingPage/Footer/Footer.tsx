...
const Footer = () => {
  return (
    <footer className="text-white bg-gradient-to-t from-indigo-600 via-purple-50 to-green-300">
      <div className="max-w-screen-xl px-4 pt-32 pb-12 mx-auto sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            className="inline-block px-12 py-3 mt-8 text-sm font-medium border rounded-full border-white/25 hover:bg-white hover:text-black from-pink-400 to-yellow-500 bg-gradient-to-t"
            href=""
          >
            Get Started
          </a>
