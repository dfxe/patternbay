...
const Footer = () => {
  return (
    <footer>
      <div className="max-w-screen-xl px-4 pt-16 pb-8 mx-auto sm:px-6 lg:px-8 flex flex-col items-center">
        <BrandLogo />

        <div className="max-w-md mx-auto">
          <strong className="block text-xl font-medium text-center text-black sm:text-3xl pt-10">
            Stay up to date.
          </strong>
          ...
          <form className="mt-6">
            <div className="relative max-w-lg">
              ...
              <input
                ...
                id="email"
                type="email"
                placeholder="me@portfolio.com"
              />

              <button
                className="absolute top-1/2 right-1.5 -translate-y-1/2 rounded-full bg-indigo-500 p-3 text-xs font-bold uppercase tracking-wide text-white transition hover:bg-indigo-700"
                type="button"
              >
                Get updates
              </button>
